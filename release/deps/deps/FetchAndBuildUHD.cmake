...
set(CMAKE_ARGS -DLIBUSB_INCLUDE_DIRS=${LIBUSB_INCLUDE_DIRS} -DCMAKE_BUILD_TYPE=Release -DLIBUSB_LIBRARIES=${LIBUSB_LIBRARIES} -DCMAKE_PREFIX_PATH=${CMAKE_PREFIX_PATH} -DUHD_RELEASE_MODE=ON -DENABLE_EXAMPLES=OFF -DENABLE_TESTS=OFF  ${EXTRA_CMAKE_ARGS_LIBUSB} -DENABLE_PYTHON_API=ON -DCMAKE_INSTALL_PREFIX=${UHD_INSTALL_DIR} "-DCMAKE_CXX_FLAGS=-DBOOST_ALL_NO_LIB /EHsc" ${EXTRA_CMAKE_ARGS_SIM} ${EXTRA_CMAKE_ARGS_PYTHON})
