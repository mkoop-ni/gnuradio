set(UHD_VERSION 4.11.0.0) # version is also used in custom install command
set(UHD_URL https://github.com/EttusResearch/uhd/archive/refs/tags/v${UHD_VERSION}.zip)
set(UHD_HASH B4CBE4C7473FE307457F2D07C6F1E9C7988DD397E4BF3B851768D2ABA97DC26C)
...
if(WIN32)
  ...
  set(EXTRA_CMAKE_ARGS_LIBUSB -DENABLE_EXTEND_WIN_PACKAGING=ON)
else()
  set(EXTRA_CMAKE_ARGS_LIBUSB -DENABLE_EXTEND_WIN_PACKAGING=OFF)
endif(WIN32)
...
set(CMAKE_ARGS -DLIBUSB_INCLUDE_DIRS=${LIBUSB_INCLUDE_DIRS} -DCMAKE_BUILD_TYPE=Release -DLIBUSB_LIBRARIES=${LIBUSB_LIBRARIES} -DCMAKE_PREFIX_PATH=${CMAKE_PREFIX_PATH} -DUHD_RELEASE_MODE=release -DENABLE_EXAMPLES=OFF -DENABLE_TESTS=OFF  ${EXTRA_CMAKE_ARGS_LIBUSB} -DENABLE_PYTHON_API=ON -DCMAKE_INSTALL_PREFIX=${UHD_INSTALL_DIR} "-DCMAKE_CXX_FLAGS=-DBOOST_ALL_NO_LIB /EHsc" ${EXTRA_CMAKE_ARGS_SIM} ${EXTRA_CMAKE_ARGS_PYTHON})
