        ...
        foreach(pyfile ${GR_PYTHON_INSTALL_PROGRAMS})
            ...
            if(WIN32)
                ...
                if(NOT pyfile_dont_wrap)
                    ...
                    if(GR_BUILD_INSTALLER)
                        set(wrapper_python_path "../${REL_PYTHON_INSTALL_PATH}/python.exe -i")
                    else()
                        ...
                        file(RELATIVE_PATH wrapper_python_path
                             ...
                             "${PYTHON_EXECUTABLE}")
                        set(wrapper_python_path "${wrapper_python_path} -i")
                    endif()

                    add_custom_command(
                        OUTPUT ${pywrapperfile} DEPENDS ${pyfile}
                        COMMAND ${PYTHON_EXECUTABLE} -c
                        "from pip._vendor.distlib.scripts import ScriptMaker; maker = ScriptMaker('${pyfile_dir}', '${pywrapperfile_dir}', add_launchers=True); maker.executable = '${wrapper_python_path}'; maker.make('${pyfile_name}')"
